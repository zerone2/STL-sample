        ...
        <div className="test-code">
          <div className="user-input-section">
            ...
            <div className="remove-form">
              <button onClick={this.hashMapRemove} style={{marginRight: 20}} disabled={!value.hideMsg}>remove</button>
              <button onClick={this.hashMapClear} disabled={!value.hideMsg}>clear</button>
            </div>
            <div className="value-form">
              <button onClick={this.hashMapContainsKey} style={{marginRight: 20}} disabled={!value.hideMsg}>containsKey</button>
              <button onClick={this.hashMapContainsValue} style={{marginRight: 20}} disabled={!value.hideMsg}>containsValue</button>
              <button onClick={this.hashMapGet} style={{marginRight: 20}} disabled={!value.hideMsg}>get</button>
              <button onClick={this.hashMapEntrySet} style={{marginRight: 20}} disabled={!value.hideMsg}>entrySet</button>
